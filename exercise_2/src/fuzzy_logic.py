...
from skfuzzy.control.controlsystem import ControlSystemSimulation, ControlSystem  # type: ignore

type Action = Literal[0, 1]


def init_simulation() -> tuple[
    ctrl.Antecedent,
    ctrl.Antecedent,
    ctrl.Antecedent,
    ctrl.Antecedent,
    ...
    rules = [
        ...
        ctrl.Rule(
            pole_angle["PL"] & (pole_vel["PS"] | pole_vel["Z"] | pole_vel["NS"]),
            force["right"],
        ),
        ctrl.Rule(
            pole_angle["NL"] & (pole_vel["NS"] | pole_vel["Z"] | pole_vel["PS"]),
            force["left"],
        ),
        ...
        ctrl.Rule(
            pole_angle["Z"] & pole_vel["Z"] & cart_pos["center"] & cart_vel["pos"],
            force["left"],
        ),
        ctrl.Rule(
            pole_angle["Z"] & pole_vel["Z"] & cart_pos["center"] & cart_vel["neg"],
            force["right"],
        ),
        ...
        # Fallback
        ctrl.Rule(
            pole_angle["Z"] & cart_pos["center"] & pole_vel["Z"] & cart_vel["zero"],
            force["zero"],
        ),
    ]
